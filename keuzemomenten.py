...
def maak_keuzemoment(root, karakter, verhaal, stage, keuzetekst, keuzeplaatje, eigenschap):
    ...
    if stage < 8:
        ...
        button_1 = Button(root, text=verhaal[stage]['keuze_1'], width=40, height=7, command=lambda: maak_keuzemoment(root, karakter, verhaal, verhaal[stage]['stap'], 'tekst_1', 'plaatje_1', ''), font=button_font)
        button_2 = Button(root, text=verhaal[stage]['keuze_2'], width=40, height=7, command=lambda: maak_keuzemoment(root, karakter, verhaal, verhaal[stage]['stap'], 'tekst_2', 'plaatje_2', ''), font=button_font)
        button_3 = Button(root, text=verhaal[stage]['keuze_3'], width=40, height=7, command=lambda: maak_keuzemoment(root, karakter, verhaal, verhaal[stage]['stap'], 'tekst_3', 'plaatje_3', verhaal[stage]['eigenschap']), font=button_font)
